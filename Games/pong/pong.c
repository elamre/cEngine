...
BaseGame * pongGame() {
	...
	pongContainer->player2 = newPaddle(CANVASS_WIDTH - 5, CANVASS_HEIGHT / 2, 0);
	pongContainer->scoreP1 = 0;
	pongContainer->scoreP2 = 0;
	Screen * screen = newScreen();
	screen->draw = draw;
	screen->update = update;
	game_setScreen(screen);
...
static void update(Screen * screen, GameDetails * gameDetails) {
	...
	if ((pongContainer->ball->entity.yPos > pongContainer->player1->entity.yPos) && pongContainer->ball->entity.yPos < pongContainer->player1->entity.yPos + pongContainer->player1->height) {
	...
	if ((pongContainer->ball->entity.yPos > pongContainer->player2->entity.yPos) && pongContainer->ball->entity.yPos < pongContainer->player2->entity.yPos + pongContainer->player2->height) {
...
static void draw(Screen * screen, GameDetails * gameDetails) {
	...
	graphical_drawRectangle(pongContainer->player1->entity.xPos, pongContainer->player1->entity.yPos, pongContainer->player1->entity.xPos + pongContainer->player1->width,
			pongContainer->player1->entity.yPos + pongContainer->player1->height, 1, BLUE);
	graphical_drawRectangle(pongContainer->player1->entity.xPos, pongContainer->player1->entity.yPos, pongContainer->player1->entity.xPos + pongContainer->player1->width,
			pongContainer->player1->entity.yPos + pongContainer->player1->height, 0, BLACK);
	graphical_drawRectangle(pongContainer->player2->entity.xPos, pongContainer->player2->entity.yPos, pongContainer->player2->entity.xPos + pongContainer->player2->width,
			pongContainer->player2->entity.yPos + pongContainer->player2->height, 1, BLUE);
	graphical_drawRectangle(pongContainer->player2->entity.xPos, pongContainer->player2->entity.yPos, pongContainer->player2->entity.xPos + pongContainer->player2->width,
			pongContainer->player2->entity.yPos + pongContainer->player2->height, 0, BLACK);
}
